...
export default function editor(p: Palette): Record<string, string> {
  ...
  return {
    ...
    'inlineEdit.gutterIndicator.primaryForeground': a.indigo,
    ...
    'inlineEdit.gutterIndicator.secondaryForeground': p.label.secondary,
    ...
    'inlineEdit.gutterIndicator.successfulForeground': a.green,
