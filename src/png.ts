/**
 * Minimal PNG encoder (RGBA8, non-interlaced) using Node's zlib. No dependencies.
 * Used to bake displacement maps into data: URIs for the Layer-2 SVG filters.
 */
...
export function pngDataUri(width: number, height: number, rgba: Uint8Array): string {
