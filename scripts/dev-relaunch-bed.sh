...
case $PORT in
  ...
  9342) APP=/Users/miloshampl/Repos/personal/vs-glass/scratch/VSCode-fresh.app/Contents/Resources/app/bin/code; ARGS=(--user-data-dir /tmp/vsg-fb2 --extensions-dir /tmp/vsg-fb2-ext) ;;  # feedback window 2
